...
public class MetricsWrapper {
    ...
    private final boolean isPaperPlugin;
    ...
    public MetricsWrapper(@NotNull final JavaPlugin plugin, final int serviceId, final boolean isPaperPlugin) {
        ...
        metricsBase =
                new MetricsBase(
                        ...
                        submitDataTask -> plugin.getServer().getGlobalRegionScheduler().execute(this.plugin, submitDataTask),
                        plugin::isEnabled,
                        logger::warn,
                        logger::info,
                        logErrors,
    ...
    public static class MetricsBase {
        ...
        private void submitData() {
            ...
            JsonObjectBuilder.JsonObject[] chartData = this.customCharts.stream().map(customChart -> customChart.getRequestJsonObject(errorLogger, logErrors)).filter(Objects::nonNull).toArray(JsonObjectBuilder.JsonObject[]::new);
